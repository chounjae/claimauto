...
export default function OnboardingPage() {
  return (
    <main id="main" className="flex min-h-dvh flex-col px-5 pb-28 md:min-h-0 md:px-10 md:pb-10">
      ...
      {/* 히어로 */}
      <section className="flex flex-1 flex-col justify-center gap-6 py-8 md:flex-none md:justify-start md:gap-8 md:pt-4">
        {/*
          첫 화면의 일은 두 가지다.
        ...
        */}
        <div className="flex flex-col gap-3">
          <h1 className="balance text-[28px] font-bold leading-tight tracking-[-0.02em] text-gray-900 md:text-[38px]">
            헬스장 환불,<br />못 받고 넘어가지 마세요
          </h1>
          <h2 className="balance text-lg font-bold leading-snug text-[#2563EB] md:text-2xl">
            계약서에 「환불 불가」라고 써 있어도<br />포기하지 마세요
          </h2>
          <p className="pretty max-w-[52ch] text-sm leading-relaxed text-gray-500 md:text-base">
      ...
      {/* 주 동작. 폰에서는 하단 고정, 데스크톱에서는 본문 흐름 안 */}
      <CTAButton href="/form" label="무료 환급액 계산하기" sublabel="무료 · 회원가입 불필요" />

      {/* 면책 및 처리방침 고지 */}
      <footer className="pb-28 pt-4 text-center text-[11px] leading-5 text-gray-400 md:pb-4">
        <p>
